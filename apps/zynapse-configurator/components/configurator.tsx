...
export function ZynapseConfigurator() {
  ...
  const formReady = !!(form.project_id && form.building_type && form.levels &&
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0A0B0E" }}>
      ...
      {/* ── Layout ── */}
      <div className="p-8" style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: "400px 1fr", gap: 24, alignItems: "start" }}>
        ...
        <div className="rounded-2xl p-6 sticky top-[73px]"
          ...
          {isAtLimit && (
            <div className="mb-4 p-4 rounded-xl"
              ...
              <div className="text-[12px]" style={{ color: "#8B6060" }}>
                Ai atins limita de {projectsLimit} proiecte pe planul gratuit.{" "}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
            ...
            <SelectField label="Regim înălțime" value={form.levels}
              onChange={v => update("levels", v)} options={LEVELS.map(l => ({ value: l, label: l }))} required />
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
          ...
          <div className="mt-1">
            <Toggle label="Boiler ACM" checked={form.has_acm_boiler} onChange={v => update("has_acm_boiler", v)} description="Preparare apă caldă menajeră" />
